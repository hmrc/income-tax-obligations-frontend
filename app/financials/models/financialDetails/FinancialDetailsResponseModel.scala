...
package financials.models.financialDetails

import financials.models.chargeSummary.{PaymentHistoryAllocation, PaymentHistoryAllocations}
import ChargeType.allChargeMainTransactions
import CreditType.{creditsWithSummaryPages, cutOver}
import financials.models.financialDetails.ReviewAndReconcileUtils.{isReviewAndReconcilePoaOne, isReviewAndReconcilePoaTwo}
import common.models.incomeSourceDetails.TaxYear
import common.models.incomeSourceDetails.TaxYear.makeTaxYearWithEndYear
import play.api.Logger
import play.api.libs.json.{Format, Json}
import common.services.DateServiceInterface
import common.services.claimToAdjustPoa.ClaimToAdjustHelper.poaDocumentDescriptions
