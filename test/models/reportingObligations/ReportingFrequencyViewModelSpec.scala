      ...
      ".getOptOutSignUpLink" should {
        "return the opt out link" when {
          "the suffix contains optOut" in {
            ...
            model.getOptOutSignUpLink(currentTaxYear, "optOut.previousYear.single") shouldBe appConfig.baseUrl + "/optout?taxYear=2025"
          }
        }
        "return the sign up link" when {
          "the suffix contains signUp" in {
            ...
            model.getOptOutSignUpLink(currentTaxYear, "signUp.currentYear") shouldBe appConfig.baseUrl + "/sign-up/start?taxYear=2025"
          }
        }
      }
