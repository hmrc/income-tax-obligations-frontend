      ...
      "return Individual error page" in {
        ...
        result match {
          case Left(res) =>
            ...
            feedbackUrl shouldBe "/manage-self-assessment/obligations/feedback" // to help distinguish error pages checking for feedback url since page titles are the same
          case Right(_) =>
      ...
      "return Agent error page" in {
        ...
        result match {
          case Left(res) =>
            ...
            res.header.status shouldBe INTERNAL_SERVER_ERROR
            title shouldBe "Sorry, there is a problem with the service - GOV.UK"
            agentFeedbackUrl shouldBe "/manage-self-assessment/obligations/agents/feedback" // to help distinguish error pages checking for feedback url since page titles are the same
          case Right(_) =>
