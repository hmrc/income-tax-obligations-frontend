...
class AccessDeniedForSupportingAgentsModelSpec extends TestSupport {
  ...
  val transactionName = common.enums.TransactionName.AccessDeniedForSupportingAgent.name
  val auditType = common.enums.AuditType.AccessDeniedForSupportingAgent.name
