  ...
  "SignUpCompletedView" when {
    "signing up for the current year" should {
      ...
      "render the correct 'Your revised deadlines' section" in new Setup(taxYear = TaxYear(2025, 2026), isCurrentYear = true) {
        ...
        pageDocument.getElementById("your-revised-deadlines-desc-2").select("a").attr("href") shouldBe appConfig.baseUrl + "/submission-deadlines"
        ...
        pageDocument.getElementById("your-revised-deadlines-desc-3").select("a").attr("href") shouldBe appConfig.baseUrl + "/reporting-frequency"
      }
      ...
      "render the correct links for agents" in new Setup(isAgent = true, taxYear = TaxYear(2025, 2026), isCurrentYear = true) {
        pageDocument.getElementById("your-revised-deadlines-desc-2").select("a").attr("href") shouldBe appConfig.agentBaseUrl + "/submission-deadlines"
        pageDocument.getElementById("your-revised-deadlines-desc-3").select("a").attr("href") shouldBe appConfig.agentBaseUrl + "/reporting-frequency"
      }
    }
