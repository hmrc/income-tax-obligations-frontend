...
import helpers.servicemocks.ITSAStatusDetailsStub
              ...
              Seq(("sole trader", businessWithLatency), ("property", propertyWithLatency), ("all", allBusinessesWithLatency)).foreach { response =>
                ...
                s"${response._1} business is latent" in {
                  ...
                  if (mtdUserRole == MTDIndividual) {
                    result should have(
                      elementAttributeBySelector(latencyDetailsLink, "href")(appConfig.businessBaseUrl + "/manage-your-businesses")
                    )
                  } else {
                    result should have(
                      elementAttributeBySelector(latencyDetailsLink, "href")(appConfig.businessBaseUrl + "/agents/manage-your-businesses")
                    )
                  }
                }
              }
